...
public class EthernetNetworkFactory extends NetworkFactory {
    ...
    //add by wangxing@20191213 for bug P_RK95_E-793
    private static final String MEIG_ETHERNET_ENABLED = "meig_ethernet_enabled";
    private static final int ETHERNET_ENABLE = 1;
    ...
    ///add by zoujiacai for Ethernet Static Ip on/off @{
    ...
    private static class NetworkInterfaceState {
        ...
        private void start() {
            ...
            if(mContext != null){
                if(Settings.Global.getInt(mContext.getContentResolver(),MEIG_ETHERNET_ENABLED, ETHERNET_ENABLE) != ETHERNET_ENABLE){
                    mLinkUp = false;
                    Log.d(TAG, "updateInterfaceLinkState meig_ethernet_enabled  disable");
                    return  ;
                };
            }
            ...
            /*if (mIpConfig.getIpAssignment() == IpAssignment.STATIC) {
                mHandler.post(() -> onIpLayerStarted(mLinkProperties));
            }*/
            ///@}
