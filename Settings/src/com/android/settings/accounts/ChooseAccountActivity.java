    ...
    private void onAuthDescriptionsUpdated() {
        ...
        if (mProviderList.size() == 1) {
            ...
            for (ProviderEntry pref : mProviderList) {
				...
				// modify by maohaojie on 2019.07.17 for bug P_RK95_E-241 start
				boolean type_not_show = (pref.type.equals("com.android.sim")) || (pref.type.equals("com.android.localphone"));
				boolean wifi_only_control = ("true".equals(SystemProperties.get("ro.build.meig.feature.wifi"))) && type_not_show;
				if(wifi_only_control){
					// not add sim card account
				}else{
					mAddAccountGroup.addPreference(p);
				}
				// modify by maohaojie on 2019.07.17 for bug P_RK95_E-241 end  
            }
