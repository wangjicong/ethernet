...
public class GestureSettings extends DashboardFragment {
    ...
    private static final String KEY_GESTURE_SCREEM = "gesture_settings_screen";//Modify by lijinhua @20191120 for P_RK95_E-757
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
					...
					//Modified by yangfeiya for JIRA522
                    //keys.add(KEY_PREVENT_RINGING);
                    keys.add(KEY_GESTURE_SCREEM); //Modify by lijinhua @20191120 for P_RK95_E-757
