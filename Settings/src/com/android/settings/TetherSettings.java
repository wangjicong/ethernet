...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        final boolean isWifiOnly = SystemProperties.getBoolean("ro.build.meig.feature.wifi",false);

        if (!usbAvailable || Utils.isMonkeyRunning() || isWifiOnly) {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mUsbTether) {
            //add by wangxing for bug 1249
            Settings.System.putInt(getContentResolver(),Settings.Global.USB_TETHER_SETTING, 1);
