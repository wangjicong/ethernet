...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    private void initializeAllPreferences() {
        ...
        if (!KeyCharacterMap.deviceHasKey(KeyEvent.KEYCODE_POWER)
                || !Utils.isVoiceCapable(getActivity()) || isWifiOnly) {
        ...
        //add by zhaohairuo for bug P_RK95_E-228
        final PreferenceScreen mscreen = getPreferenceScreen();
        mscreen.removePreference(mAccessibilityShortcutPreferenceScreen);
        // Vibrations.
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    keys.add(ACCESSIBILITY_SHORTCUT_PREFERENCE);//Modify by lijinhua @20191120 for P_RK95_E-758
