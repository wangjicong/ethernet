...
public class SoundSettings extends DashboardFragment {
    ...
    public void onAttach(Context context) {
        ...
        //MEGI@jiangdanyang:remove ring and call volume if wifionly 20190704 ---- start
        boolean isWifiOnly = SystemProperties.getBoolean("ro.meig.feature.wifionly", true);
        if (!isWifiOnly){
            volumeControllers.add(use(RingVolumePreferenceController.class));
            volumeControllers.add(use(CallVolumePreferenceController.class));
        }
        //MEGI@jiangdanyang:remove ring and call volume if wifionly 20190704 ---- end
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        final KeypadSoundPreferenceController keypadSoundPreferenceController =
                new KeypadSoundPreferenceController(context, fragment, lifecycle);
        ...
        controllers.add(keypadSoundPreferenceController);
        controllers.add(vibrateOnTouchPreferenceController);
        controllers.add(dockAudioMediaPreferenceController);
        controllers.add(bootSoundPreferenceController);
        controllers.add(emergencyTonePreferenceController);
        ///P_CENTAURUS_E-30 Headset and mic support outdoor mod
        controllers.add(new VoiceModePreferenceController(context));
        controllers.add(new HeadsetPlaybackModePreferenceController(context));
        controllers.add(new PreferenceCategoryController(context,
                ...
                Arrays.asList(dialPadTonePreferenceController,
                        ...
                        keypadSoundPreferenceController,
