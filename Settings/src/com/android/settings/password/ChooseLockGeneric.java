...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static boolean isScreenLockUsed = false;
    @Override
        ...
        protected void disableUnusablePreferencesImpl(final int quality,
            ...
            for (ScreenLockType lock : ScreenLockType.values()) {
                ...
                if (pref instanceof RestrictedPreference) {
                    ...
                    // P_RK95_E-720 modify by xuxiangtian 20191114 start
                    if (ChooseLockGeneric.isScreenLockUsed && (lock==ScreenLockType.NONE || lock==ScreenLockType.SWIPE)){
                        ((RestrictedPreference) pref).setDisabledByAdmin(null);
                        pref.setEnabled(false);
                    }
                    // P_RK95_E-720 modify by xuxiangtian 20191114 end
                }
            }
        }
