...
public class LocationSettings extends DashboardFragment {
    ...
    //Modify by lijinhua @20191121 for P_RK95_E-761
    public static final String KEY_LOCATION_SERVICES = "location_services";
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                //Modify by lijinhua @20191121 for P_RK95_E-761 start
                @Override
                public List<String> getNonIndexableKeys(Context context) {
                    List<String> keys = super.getNonIndexableKeys(context);
                    keys.add(KEY_LOCATION_SETTINGS);
                    keys.add(KEY_LOCATION_SERVICES);
                    return keys;
                }
                //Modify by lijinhua @20191121 for P_RK95_E-761 end
                @Override
