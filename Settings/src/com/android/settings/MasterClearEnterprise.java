 ...
 */
public class MasterClearEnterprise extends InstrumentedFragment implements OnGlobalLayoutListener {
    private static final String TAG = "MasterClearEnterprise";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.master_clear_title_with_enterprise);
    }
    ...
    private boolean runKeyguardConfirmation(int request) {
        ...
        return new ChooseLockSettingsHelper(getActivity(), this).launchConfirmationActivity(
                request, res.getText(R.string.master_clear_title_with_enterprise));
    }
    ...
    void showFinalConfirmation() {
        ...
        new SubSettingLauncher(getContext())
                .setDestination(MasterClearConfirmEnterprise.class.getName())
                .setArguments(args)
    ...
    void establishInitialState() {
        mInitiateButton = mContentView.findViewById(R.id.initiate_master_clear_e);
        mInitiateButton.setOnClickListener(mInitiateListener);
        mExternalStorageContainer = mContentView.findViewById(R.id.erase_external_container_e);
        mExternalStorage = mContentView.findViewById(R.id.erase_external_e);
        ...
        mScrollView = mContentView.findViewById(R.id.master_clear_scrollview_e);
        ...
        if (isExtStorageEmulated
            ...
            final View externalOption = mContentView.findViewById(R.id.erase_external_option_text_e);
            externalOption.setVisibility(View.GONE);

            final View externalAlsoErased = mContentView.findViewById(R.id.also_erases_external_e);
        ...
        if (showWipeEuicc()) {
            if (showWipeEuiccCheckbox()) {
                ...
                final View esimAlsoErased = mContentView.findViewById(R.id.also_erases_esim_e);
        ...
        final View masterClearContainer = mContentView.findViewById(R.id.master_clear_container_e);
    ...
    private void loadAccountList(final UserManager um) {
        View accountsLabel = mContentView.findViewById(R.id.accounts_label_e);
        LinearLayout contents = (LinearLayout)mContentView.findViewById(R.id.accounts_e);
        ...
        View otherUsers = mContentView.findViewById(R.id.other_users_present_e);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContentView = inflater.inflate(R.layout.master_clear_enterprise, null);
