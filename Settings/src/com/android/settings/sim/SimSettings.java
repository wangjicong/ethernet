...
public class SimSettings extends RestrictedSettingsFragment implements Indexable {
    ...
    public static final String KEY_ACTIVITY = "sim_activities";
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                //Modify by lijinhua @20191120 for P_RK95_E-763 start
                @Override
                public List<String> getNonIndexableKeys(Context context) {
                    List<String> keys = super.getNonIndexableKeys(context);
                    keys.add(SIM_CARD_CATEGORY);
                    keys.add(KEY_CELLULAR_DATA);
                    keys.add(KEY_ACTIVITY);
                    keys.add(KEY_CALLS);
                    return keys;
                }
                //Modify by lijinhua @20191120 for P_RK95_E-763 end
            };
