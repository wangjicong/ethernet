...
public class AutoRotatePreferenceController extends TogglePreferenceController implements
	...
	//Meig@jiangdanyang added summary for rotate 20190419 --- start
    //private Preference mPreference;
	private TwoStatePreference mPreference;
	//Meig@jiangdanyang added summary for rotate 20190419 --- end
    ...
    public void updateState(Preference preference) {
    	//Meig@jiangdanyang added summary for rotate 20190419 --- start
		//mPreference = (Preference) preference;
        mPreference = (TwoStatePreference) preference;
        super.updateState(preference);
		mPreference.setSummaryOn(R.string.auto_rotate_on);
        mPreference.setSummaryOff(R.string.auto_rotate_off);
		//Meig@jiangdanyang added summary for rotate 20190419 --- end
    }
