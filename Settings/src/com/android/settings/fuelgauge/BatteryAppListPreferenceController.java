...
public class BatteryAppListPreferenceController extends AbstractPreferenceController
    ...
    public void refreshAppListGroup(BatteryStatsHelper statsHelper, boolean showAllApps) {
        ...
        if (averagePower >= MIN_AVERAGE_POWER_THRESHOLD_MILLI_AMP || USE_FAKE_DATA) {
			...
			//MEIG-jiangdanyang@show battery sippers 20190724 --- start
            //double hiddenPowerMah = showAllApps ? 0 : mBatteryUtils.removeHiddenBatterySippers(usageList);
			double hiddenPowerMah = 0;
			//MEIG-jiangdanyang@show battery sippers 20190724 --- end
