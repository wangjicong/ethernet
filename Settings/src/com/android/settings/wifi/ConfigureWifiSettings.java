...
public class ConfigureWifiSettings extends DashboardFragment {
    ...
    public static final String KEY_CELLULAR_FALLBACK = "wifi_cellular_data_fallback";// add by xuxiangtian for E-564
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        ///P_CENTAURUS_E-33 set wifi country code @{
        controllers.add(new CountryCodePreferenceController(context, wifiManager));
        ///@}
        /** add by wangxing@20190410 for wifi scan interval  @{ */
        controllers.add(new ScanIntervalPreferenceController(context, wifiManager));
        /* @}*/
        /// P_CENTAURUS_E-18 set wifi frequency band @{
        controllers.add(new FrequencyBandPreferenceController(context, wifiManager));
        ///@}
        ///P_CENTAURUS_E-16 set roaming config @{
        controllers.add(new RoamEnablePreferenceController(context, wifiManager));
        controllers.add(new RoamTriggerPreferenceController(context, wifiManager));
        controllers.add(new RoamDeltaPreferenceController(context, wifiManager));
        ///@}
        return controllers;
    }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    keys.add(KEY_CELLULAR_FALLBACK);// add by xuxiangtian for E-564
