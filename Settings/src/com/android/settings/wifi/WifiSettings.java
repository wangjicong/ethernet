...
public class WifiSettings extends RestrictedSettingsFragment
            ...
            if (preference instanceof LongPressAccessPointPreference) {
                ...
                if (mSelectedAccessPoint.isSaved()) {
                    ...
                    if (nfcAdapter != null && nfcAdapter.isEnabled() &&
                            mSelectedAccessPoint.getSecurity() != AccessPoint.SECURITY_NONE&& mSelectedAccessPoint.isActive()) {// modify by lijinhua on 20191106 for bug PK98E-737
    ...
    private boolean configureConnectedAccessPointPreferenceCategory(
        ...
        // modify by lijinhua on 20191106 for bug PK98E-737 start 
       ...
       ((LongPressAccessPointPreference) mConnectedAccessPointPreferenceCategory.getPreference(0))
                .refresh();
        // modify by lijinhua on 20191106 for bug PK98E-737 end 
        return true;
    }
    ...
    //add by lijinhua on 20191106 for bug PK98E-737 start
   @NonNull
    ...
    //add by lijinhua on 20191106 for bug PK98E-737 end
