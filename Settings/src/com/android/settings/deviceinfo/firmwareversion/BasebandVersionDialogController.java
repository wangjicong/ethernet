...
public class BasebandVersionDialogController {
    ...
    public void initialize() {
        ...
        //wangxing add for bug 1329 start
        boolean isMeigWifiOnly = SystemProperties.getBoolean("ro.meig.feature.wifionly",true);
        
        if (Utils.isWifiOnly(context) || isMeigWifiOnly) {
        //wangxing add end	
