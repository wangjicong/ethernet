...
public class PhoneNumberPreferenceController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        //MEIG@jiangdanyang:delete sim menu if wifionly 20190528 --- start
        boolean isWifiOnly = SystemProperties.getBoolean("ro.meig.feature.wifionly", true);
        if (getPreferenceKey().equals("phone_number") && isWifiOnly){
            return;
        }
        //MEIG@jiangdanyang:delete sim menu if wifionly 20190528 --- end
