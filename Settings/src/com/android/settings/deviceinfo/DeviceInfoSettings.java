...
public class DeviceInfoSettings extends DashboardFragment implements Indexable {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                //wangxing add for bug 1590 start
                @Override
                protected boolean isPageSearchEnabled(Context context) {
                    FeatureFactory featureFactory = FeatureFactory.getFactory(context);
	                boolean aboutPhoneV2Enabled = featureFactory
                              .getAccountFeatureProvider()
                              .isAboutPhoneV2Enabled(context);
	                if(aboutPhoneV2Enabled){	
                        return false;
                    }else{
                        return true;
                    }
                }
                //wangxing add for bug 1590 end
